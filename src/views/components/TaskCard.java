...
public class TaskCard extends JPanel {
    ...
    public TaskCard(String taskId , String projectName ,String taskDetail ,  String userAssigned , String taskName   , Dimension size) throws ClassNotFoundException, SQLException{
        this.size = size;
        this.taskId = taskId;
        ...
        this.setFont(new Font("Roboto",Font.BOLD,50));
         JFrame frame = new JFrame("TaskCard UI Example");
        ...
        //     JLabel titleLabel = new JLabel("TaskCard Title " + (i+1));
		...
		JLabel descLabel = new JLabel("<html><body><p style='width: 320px; height:500px;'> Task Details - "+ taskDetail + "</p></body></html>");
		JLabel descLabel1 = new JLabel("<html><body><p style='width: 320px; height:500px;'> Issued by - "+ userAssigned + "</p></body></html>");
