...
public class Card extends JPanel {
    ...
    public Card(String title,Dimension size , String name , String desc , String owner , String repoUrl, String projectId , int userId) throws ClassNotFoundException, SQLException{
        this.size = size;
        this.title = title;
        this.desc = desc;
        this.projectId = projectId;
        this.repoUlr = repoUrl;
        this.owner = owner;
        this.name = name;
        this.setVisible(true);
        this.setPreferredSize(this.size);
        // forkButton.addActionListener(e -> showMessageDialog("You have su"));
		...
		forkButton.setBackground(Color.BLUE);
        ...
        JLabel titleLable = new JLabel("<html><body><p style='width: 320px; height:500px; background-color:white;'> <h1 style='font-weight:'bold'; color:red;'> 📚 "+ name + "</h1></p></body></html>");
		JLabel descLabel = new JLabel("<html><body><p style='width: 320px; height:500px;'>"+ desc + "</p></body></html>");
		JLabel descLabel1 = new JLabel("<html><body><p style='width: 320px; height:500px;'> Owned By - "+ owner + "</p></body></html>");
